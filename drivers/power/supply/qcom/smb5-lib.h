...
#define SDP_100_MA (mi_is_ginkgo() ? 500000 : 100000)
#define SDP_CURRENT_UA 500000
#define CDP_CURRENT_UA 1500000
#define FLOAT_CURRENT_UA 1000000
#define DCP_CURRENT_UA ((mi_is_ginkgo() || mi_is_laurel()) ? 2000000 : 1500000)
#define HVDCP_CURRENT_UA                                                       \
  (mi_is_ginkgo() ? 3000000 : (mi_is_laurel() ? 2000000 : 3000000))
#define HVDCP2_CURRENT_UA 1500000
#define TYPEC_HIGH_CURRENT_UA                                                  \
  (mi_is_ginkgo() ? 3000000 : (mi_is_laurel() ? 2000000 : 3000000))
